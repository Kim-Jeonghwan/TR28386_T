...
{
    xXmtIpcMsg1.Tact01 = false;
    xXmtIpcMsg1.Tact02 = false;
}

/**
 * @brief Tact 스위치 상태를 읽어 IPC 송신 구조체에 저장
 * @details GPIO 64번 -> xXmtIpcMsg1.Tact01
 *          GPIO 65번 -> xXmtIpcMsg1.Tact02
 */
void updateTactStatus(void)
{
    // GPIO 상태를 직접 읽어 구조체에 반영
    xXmtIpcMsg1.Tact01 = (bool)GPIO_readPin(GPIO_TACT_01);
    xXmtIpcMsg1.Tact02 = (bool)GPIO_readPin(GPIO_TACT_02);
}
