...
/* ************************** [[   define   ]]  *********************************************************** */
#define SCI_PC_GPIO_PIN_SCIA_RXD	28u             // GPIO number for SCI RX
#define SCI_PC_GPIO_PIN_SCIA_TXD	29u             // GPIO number for SCI TX
#define SCI_PC_GPIO_CFG_SCIA_RXD	GPIO_28_SCIA_RX	// "pinConfig" for SCI RX
#define SCI_PC_GPIO_CFG_SCIA_TXD	GPIO_29_SCIA_TX	// "pinConfig" for SCI TX
